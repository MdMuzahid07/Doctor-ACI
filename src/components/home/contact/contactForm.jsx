...
import SelectHowDidYouFindUs from "./select-how-did-you-find-us";
    ...
    return (
        <section>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input className="text-center px-3 py-2 w-full bg-indigo-500 text-white font-bold" type="submit" value="SEND" />
            </form>
        </section>
    );
}
